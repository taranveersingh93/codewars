...
function feast(beast, dish) {
    var beastArray = beast.split("");
    var beastFirst = beastArray[0];
    var beastLast = beastArray[beastArray.length-1];
    var dishArray = dish.split("");
    var dishFirst = dishArray[0];
    var dishLast = dishArray[dishArray.length-1];
    return (dishLast===beastLast && dishFirst===beastFirst);        
}